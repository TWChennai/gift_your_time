        ...
        if (this.options.events.length) {
            ...
            if (this.options.multiDayEvents) {
                this.eventsThisMonth = $(this.options.events).filter(function() {
                    return this._clndrStartDateObject.format("YYYY-MM") <= currentMonth.format("YYYY-MM") || currentMonth.format("YYYY-MM") <= this._clndrEndDateObject.format("YYYY-MM");
                }).toArray();
                ...
                if (this.options.showAdjacentMonths) {
                    ...
                    this.eventsLastMonth = $(this.options.events).filter(function() {
                        return this._clndrStartDateObject.format("YYYY-MM") <= lastMonth.format("YYYY-MM") || lastMonth.format("YYYY-MM") <= this._clndrEndDateObject.format("YYYY-MM");
                    }).toArray();

                    this.eventsNextMonth = $(this.options.events).filter(function() {
                        return this._clndrStartDateObject.format("YYYY-MM") <= nextMonth.format("YYYY-MM") || nextMonth.format("YYYY-MM") <= this._clndrEndDateObject.format("YYYY-MM");
                    }).toArray();
                }
            }
